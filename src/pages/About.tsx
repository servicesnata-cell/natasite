  ...
  return (
    <div className="bg-black min-h-screen pt-24 px-6">
      ...
      <div
        ...
        style={{ backgroundImage: "url('/ab.jpeg')", backgroundAttachment: 'fixed' }}
      >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              {/* Mission Card */}
              <div className="card-hover relative bg-gray-900 border border-gray-800 p-10 rounded-xl">
                <div className="absolute top-0 right-0 w-24 h-24 bg-white/5 -mr-12 -mt-12 transition-all duration-300"></div>
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {[
              ...
              return (
                <div key={index} className="card-hover relative bg-gray-900 border border-gray-800 p-10 rounded-xl min-h-[280px] flex flex-col">
                  <div className="w-14 h-14 bg-gray-800 flex items-center justify-center mb-6 rounded-md">
      ...
      <section className="py-24 border-t border-gray-800">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/contact"
              className="px-8 py-3.5 bg-white text-black font-semibold hover:bg-gray-100 transition-all duration-300 rounded-md"
            >
              Contact Us
            </a>
            <a
              href="/services"
              className="px-8 py-3.5 bg-transparent text-white font-semibold border-2 border-white/40 hover:border-white/80 transition-all duration-300 rounded-md"
            >
              View Services
            </a>
          </div>
