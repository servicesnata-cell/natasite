...
export default function Services() {
  return (
    <div className="bg-black min-h-screen pt-20">
      ...
      {/* Hero Section */}
      <div className="relative py-24 overflow-hidden bg-cover bg-center" style={{ backgroundImage: "url('https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&cs=tinysrgb&w=1600')" }}>
          ...
          return (
            ...
            >
              ...
              <div className="relative p-10 min-h-[360px] flex flex-col">
                ...
                <p className="text-gray-300 mb-8 flex-grow text-lg">{service.description}</p>
      ...
      {/* CTA Section */}
      <section className="py-24 bg-black border-t border-gray-800 animate-fade-in-up">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <a
            href="/contact"
            className="inline-block px-8 py-4 bg-cyan-500 hover:bg-cyan-600 text-white font-semibold transition-colors duration-300"
          >
            Contact Us Today
          </a>
        </div>
