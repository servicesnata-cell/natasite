    ...
    <div className="bg-white min-h-screen pt-16 md:pt-20">
      ...
      >
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-blue-200 max-w-3xl mx-auto">
      ...
      <style>{`
        ...
        .form-label {
          ...
          color: #3b82f6; background: transparent; padding: 0 4px;
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 sm:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div ref={leftRef} className={`space-y-6 ${leftVisible ? 'reveal-up visible' : 'reveal-up'}`}>
            <div className="bg-blue-50 p-6 sm:p-8 border border-blue-200 rounded-2xl space-y-6">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-500 text-white flex items-center justify-center rounded-md flex-shrink-0">
                    <Mail size={18} />
                  </div>
                  <div>
                    <h4 className="text-blue-900 font-semibold">Email</h4>
                    <a href="mailto:info@nataconsultancy.com" className="text-blue-700 hover:text-blue-900">
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-800">USA: +1 404-593-8792</p>
                    <p className="text-blue-800">India: +91 8886665220</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h4 className="text-blue-900 font-semibold">Offices</h4>
                    <p className="text-blue-800">Atlanta, Georgia</p>
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h4 className="text-blue-900 font-semibold">Business Hours</h4>
                    <p className="text-blue-800">Mon-Fri: 9:00 AM - 6:00 PM</p>
                    <p className="text-blue-800">Sat: 10:00 AM - 2:00 PM</p>
                    <p className="text-blue-800">Sun: Closed</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-2xl">
                <h4 className="text-blue-900 font-semibold">Atlanta, USA</h4>
                <p className="text-blue-800 text-sm mt-2">123 Technology Drive<br />Atlanta, GA 30303</p>
                <a href="https://www.google.com/maps/search/?api=1&query=Atlanta%2C+GA" target="_blank" rel="noreferrer" className="mt-2 inline-block text-cyan-500">Open in Maps</a>
              </div>
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-2xl">
                <h4 className="text-blue-900 font-semibold">Hyderabad, India</h4>
                <p className="text-blue-800 text-sm mt-2">Hitech City, Hyderabad<br />Telangana, 500081</p>
                <a href="https://www.google.com/maps/search/?api=1&query=Hyderabad%2C+India" target="_blank" rel="noreferrer" className="mt-2 inline-block text-cyan-500">Open in Maps</a>
              </div>
            </div>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="form-field">
                    <input
                      ...
                      className="w-full px-4 py-3 bg-blue-50 border border-blue-200 rounded-md text-blue-900 outline-none focus:ring-2 focus:ring-blue-300"
                      placeholder=" "
                    />
                ...
                <div className="form-field">
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-blue-50 border border-blue-200 rounded-md text-blue-900 outline-none focus:ring-2 focus:ring-blue-300 resize-none"
                    placeholder=" "
                  ></textarea>
                ...
                <div>
                  <button
                    ...
                    className={`w-full flex items-center justify-center space-x-2 px-6 py-3 text-white font-semibold rounded-md transition-all duration-300 shadow-lg ${
                      loading ? 'bg-blue-300 cursor-wait shadow-blue-400/40' : 'bg-blue-700 hover:bg-blue-800'
                    }`}
                  >
                    <Send size={18} />
      ...
      <section className="py-12 sm:py-16 bg-blue-50">
        <div className="max-w-3xl mx-auto px-6">
          <h3 className="text-3xl font-bold text-blue-900 mb-6">Frequently Asked Questions</h3>
          <div className="space-y-3">
            <details className="bg-white p-4 rounded-lg border border-blue-200">
              <summary className="cursor-pointer text-blue-900 font-medium">How quickly will you respond to enquiries?</summary>
              <div className="mt-2 text-blue-800">We typically respond within 24-48 hours for standard enquiries. For urgent matters, please call our sales line.</div>
            </details>

            <details className="bg-white p-4 rounded-lg border border-blue-200">
              <summary className="cursor-pointer text-blue-900 font-medium">Do you offer global staffing and remote teams?</summary>
              <div className="mt-2 text-blue-800">Yes — we provide global staffing solutions across India and the USA with flexible engagement models.</div>
            </details>

            <details className="bg-white p-4 rounded-lg border border-blue-200">
              <summary className="cursor-pointer text-blue-900 font-medium">Can you handle enterprise-scale cloud migrations?</summary>
              <div className="mt-2 text-blue-800">Absolutely. We have experience migrating large-scale workloads across Azure, AWS and Google Cloud with minimal disruption.</div>
            </details>
          </div>
        </div>
      </section>
